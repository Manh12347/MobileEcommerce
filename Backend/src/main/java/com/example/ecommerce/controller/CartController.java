...
public class CartController {
    ...
    /**
     * GET /v1/api/cart — Lấy hoặc tạo giỏ hàng của user đang đăng nhập
     */
    @GetMapping
    ...
    /**
     * POST /v1/api/cart/items — Thêm sản phẩm vào giỏ
     */
    @PostMapping("/items")
    ...
    /**
     * PUT /v1/api/cart/items/{cartItemId} — Cập nhật số lượng
     */
    ...
    /**
     * DELETE /v1/api/cart/items/{cartItemId} — Xóa một sản phẩm khỏi giỏ
     */
    ...
    /**
     * DELETE /v1/api/cart — Xóa toàn bộ sản phẩm trong giỏ
     */
    @DeleteMapping
