...
String _formatSpecKey(String key) {
  final Map<String, String> translations = {
    ...
    'requires_ram_slots': 'Số khe RAM yêu cầu',

    // GPU specs
    'gpu_family': 'Dòng GPU',
    'gpu_series': 'Series GPU',
    ...
    'hdmi': 'Cổng HDMI',
    'displayport': 'Cổng DisplayPort',
    'recommended_psu_w': 'Công suất nguồn khuyến nghị',
    'slot_width': 'Độ dày khe cắm',
    'display': 'Cổng xuất hình',
    'required_slots': 'Số khe cắm chiếm dụng',

    // RAM specs
    'speed_mhz': 'Tốc độ bus (MHz)',
    'total_capacity_gb': 'Tổng dung lượng (GB)',
    'module_capacity_gb': 'Dung lượng mỗi thanh',
    'module_count': 'Số lượng thanh',
    'voltage_v': 'Điện áp (V)',
    'latency': 'Độ trễ (Latency)',
    'ecc': 'Hỗ trợ ECC',
    'registered_buffered': 'Loại RAM (Registered/Buffered)',
    'profile_support': 'Hỗ trợ Profile (XMP/EXPO)',
    'heat_spreader': 'Tản nhiệt nhôm',
    'ram_kind': 'Thế hệ RAM',
    'max_memory_speed': 'Tốc độ RAM tối đa hỗ trợ',

    // PSU specs
    'efficiency': 'Hiệu suất nguồn',
    'power_connectors': 'Cổng nguồn đầu ra',

    // Storage specs (SSD/HDD)
    'pcie_generation': 'Thế hệ PCIe',
    'requires_m2_slot': 'Yêu cầu khe cắm M.2',
    'requires_pcie_generation': 'Yêu cầu thế hệ PCIe',
    'requires_sata_port': 'Yêu cầu cổng SATA',
    'requires_sata_power': 'Yêu cầu nguồn SATA',

    // Case specs
    'case_size': 'Kích thước Case',
    'motherboard_form_factors': 'Hỗ trợ Mainboard',
    'max_gpu_length_mm': 'Chiều dài GPU tối đa (mm)',
    'max_cpu_cooler_height_mm': 'Chiều cao tản CPU tối đa (mm)',
    'psu_form_factors': 'Hỗ trợ nguồn (PSU)',
    'storage_bays': 'Khay ổ cứng',
    'front_panel': 'Cổng kết nối mặt trước',
    'side_panel': 'Mặt hông',
    'lighting': 'Đèn LED',
    'fan_support_mm': 'Kích thước quạt hỗ trợ (mm)',
    'radiator_support_mm': 'Kích thước két nước hỗ trợ (mm)',
    'front': 'Quạt lắp sẵn mặt trước',
    'top': 'Quạt lắp sẵn mặt trên',
    'rear': 'Quạt lắp sẵn mặt sau',
    'required_case_form_factors': 'Chuẩn Case yêu cầu',
    'required_case_gpu_clearance_mm': 'Chiều dài GPU yêu cầu (mm)',
    'requires_case_cpu_cooler_clearance_mm': 'Chiều cao tản CPU yêu cầu (mm)',

    // Cooler / Fan specs
    'cooler_type': 'Loại tản nhiệt',
    'radiator_size_mm': 'Kích thước két nước (mm)',
    'fan_size_mm': 'Kích thước quạt (mm)',
    'fan_count': 'Số lượng quạt',
    'dual_tower': 'Tháp đôi (Dual Tower)',
    'allowed_mount_positions': 'Vị trí lắp đặt cho phép',
    'requires_radiator_mount': 'Kích thước két nước yêu cầu',
