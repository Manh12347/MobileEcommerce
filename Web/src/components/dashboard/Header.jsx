...
const breadcrumbMap = {
  ...
  "/dashboard/users": { parent: "Trang chủ", current: "Người dùng" },
  "/dashboard/discounts": { parent: "Trang chủ", current: "Giảm giá" },
  "/dashboard/brands": { parent: "Trang chủ", current: "Thương hiệu" },
  "/dashboard/categories": { parent: "Trang chủ", current: "Danh mục" },
  "/dashboard/products": { parent: "Trang chủ", current: "Sản phẩm" },
  "/dashboard/orders": { parent: "Trang chủ", current: "Đơn hàng" },
  "/dashboard/warranty": { parent: "Trang chủ", current: "Bảo hành" },
}

export function Header({ sidebarCollapsed, onMenuClick }) {
  const pathname = window.location.pathname
  const breadcrumb = breadcrumbMap[pathname] || { parent: "Trang chủ", current: "Admin" }
