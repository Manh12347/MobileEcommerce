...
import { Search, Plus, Tag, Calendar, Percent, MoreVertical, Trash2, Edit } from "lucide-react"
      ...
      <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            ...
            <div>
              <label className="text-sm font-medium mb-1 block">Tên chương trình</label>
